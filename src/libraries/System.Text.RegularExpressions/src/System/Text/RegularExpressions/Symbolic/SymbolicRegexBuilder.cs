            ...
            where TNewSet : IComparable<TNewSet>, IEquatable<TNewSet>
        {
            ...
            switch (sr._kind)
            {
                ...
                case SymbolicRegexNodeKind.OrderedOr:
                    ...
                    return SymbolicRegexNode<TNewSet>.OrderedOr(builder, Transform(sr._left, builder, setTransformer), Transform(sr._right, builder, setTransformer), deduplicated: true);
